"""ECG reconstructability: can Ch4's successor-prediction problems still be posed
on the *constructed* (predicted -> repaired -> admitted) graph, not just on gold?

Ch4 (CGEP) poses one successor query per gold Event-Causality-Graph query edge
...
from finekg.succession.data.cgep import _topology_edges, extract_ecgs, query_edge_indices
