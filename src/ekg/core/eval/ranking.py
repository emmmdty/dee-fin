...
ICEWS / FinDKG. They are retained for archived TKG artifacts; CGEP metrics live
in ``ekg.succession.metrics``. Queries whose gold answer is absent count as
...
from ekg.core.schema import Prediction
