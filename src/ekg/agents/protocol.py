...
The relation stage is organised as a small society of
...
the `relations/` domain and self-register in `agent_roles`, so the
orchestration never depends on a particular stage — mirroring the extractor
registry.
