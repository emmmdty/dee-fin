"""Selective conformal head over CGEP (the reasoning-stage predictor).

Turns a `SuccessorPredictor`'s candidate scores into a conformal *prediction set*
with a coverage guarantee and traces the risk-coverage curve. It is a reliability
module, which holds whether or not point-prediction MRR improves.
...
from ekg.core.calibration.propagation import run_cross_stage
from ekg.succession.data.cgep import CgepInstance
from ekg.succession.metrics import sedgpl_rank, strict_rank
from ekg.succession.predictor import SuccessorPredictor, UnscorableInstance
