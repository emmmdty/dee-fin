...
from ekg.relations.rl.dataset import DocStore
from ekg.rl.reward import CompositeReward
...
class TrlRewardAdapter:
    ...
    def curve(self) -> list[dict[str, float]]:
        ...
        time. This is the time series the exit criterion ("all components rising
        together") is read from.
        """
