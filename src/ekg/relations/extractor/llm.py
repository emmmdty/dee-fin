...
once" formulation (cf. LLMERE, COLING 2025). This is the retained generative
baseline; `supervised.py` is the discriminative extractor that superseded it as
the default. Differences from
